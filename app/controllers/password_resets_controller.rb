class PasswordResetsController < ApplicationController
  ...
  def edit
    # No additional code needed here, @user is already set by user_by_token in the before_action filter
  end
  ...
  def create
    ...
    redirect_to login_path, flash: {
      success: "If the provided email address exists in our system, password reset instructions have been sent to it."
    }
  end
  ...
  def user_by_token
    ...
    redirect_to login_path, flash: {
      error: "The password reset link has expired or invalid. Please request a new one."
    }
  end
